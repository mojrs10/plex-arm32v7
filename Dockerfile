...
ARG VERSION
ARG PLEX_RELEASE
LABEL build_version="Linuxserver.io & mojrapid version:- ${VERSION} Build-date:- ${BUILD_DATE}"
...
ENV DEBIAN_FRONTEND="noninteractive" \
  ...
  PLEX_MEDIA_SERVER_INFO_DEVICE="Docker Container (LinuxServer.io & mojrapid)"
